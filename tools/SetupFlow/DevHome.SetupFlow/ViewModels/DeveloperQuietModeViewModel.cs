...
public partial class DeveloperQuietModeViewModel : ObservableObject
{
    ...
    public void TerminateCurrentFlow(string callerNameForTelemetry)
    {
        ...
        TelemetryFactory.Get<ITelemetry>().Log("DeveloperQuietMode_Termination", LogLevel.Critical, new EndFlowEvent(callerNameForTelemetry), relatedActivityId: Orchestrator.ActivityId);
