 ...
 */
/* Compiler settings for C:\Users\jwhites\AppData\Local\Temp\DevHome.QuietBackgroundProcesses.QuietBackgroundProcessesSessionManager.idl-543fe051:
...
#ifndef ____x_ABI_CDevHome_CQuietBackgroundProcesses_CIQuietBackgroundProcessesSessionManagerStatics_INTERFACE_DEFINED__
...
EXTERN_C const IID IID___x_ABI_CDevHome_CQuietBackgroundProcesses_CIQuietBackgroundProcessesSessionManagerStatics;
    ...
    __x_ABI_CDevHome_CQuietBackgroundProcesses_CIQuietBackgroundProcessesSessionManagerStatics : public IInspectable
    {
    public:
    ...
    typedef struct __x_ABI_CDevHome_CQuietBackgroundProcesses_CIQuietBackgroundProcessesSessionManagerStaticsVtbl
    {
        ...
        DECLSPEC_XFGVIRT(__x_ABI_CDevHome_CQuietBackgroundProcesses_CIQuietBackgroundProcessesSessionManagerStatics, GetSession)
        ...
        DECLSPEC_XFGVIRT(__x_ABI_CDevHome_CQuietBackgroundProcesses_CIQuietBackgroundProcessesSessionManagerStatics, TryGetSession)
...
#endif 	/* ____x_ABI_CDevHome_CQuietBackgroundProcesses_CIQuietBackgroundProcessesSessionManagerStatics_INTERFACE_DEFINED__ */
