...
using namespace ABI::DevHome::Experiments::QuietBackgroundProcesses;
using namespace ABI::Windows::Foundation;
using namespace ABI::Windows::System::Threading;

namespace ABI { namespace DevHome { namespace Experiments { namespace QuietBackgroundProcesses {

                class Bread WrlFinal : public RuntimeClass<IBread>
                {
                    InspectableClass(RuntimeClass_DevHome_Experiments_QuietBackgroundProcesses_Bread, TrustLevel::BaseTrust);
                public:
                ...
                {
                    InspectableClass(RuntimeClass_DevHome_Experiments_QuietBackgroundProcesses_Oven, TrustLevel::BaseTrust);
                ...
                {
                    InspectableClass(RuntimeClass_DevHome_Experiments_QuietBackgroundProcesses_BreadBakedEventArgs, TrustLevel::BaseTrust)
