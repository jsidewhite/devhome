...
public:
    ...
    BEGIN_COMPLIANT_MEASURES_ACTIVITY_CLASS_WITH_LEVEL(QuietBackgroundProcesses_ElevatedServer_Session, PDT_ProductAndServicePerformance, WINEVENT_LEVEL_CRITICAL);
